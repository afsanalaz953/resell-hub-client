...
const BuyerOverviewPage = () => {
    return (
        ...
        <div className="card bg-white w-50 h-60 shadow-md border-0 rounded-2xl justify-start items-left "> 
          ...
          <div className="card-body items-center text-center">
            ...
            <p className='line-clamp-3'>100 </p>
                  ...
                  {/* card2 */}
                <div className="card text-left bg-white  w-50 h-60  shadow-md border-0 rounded-2xl">
         ...
         <FaRegHeart className='w-10 h-10'  />
           ...
           <div className="card-body items-center text-center">
             ...
             <p>20</p>
                   ...
                   {/* card3 */}
         <div className="card bg-white w-50 h-60 shadow-md border-0 rounded-2xl items-center text-center">
          <figure className="px-10 pt-10  ">
