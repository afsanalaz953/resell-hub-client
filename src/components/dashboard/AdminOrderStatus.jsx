...
// adminorderid
const AdminOrderStatusUpdate = ({adminorderid, status, }) => {
   const router = useRouter(); 
  const normalizedStatus = status?.toLowerCase();
   console.log(adminorderid, "orderid")
const handleApprove = async () =>{ 
//     const {data:tokenData} = await authClient.token()
//   console.log(tokenData, "tokendata")

try{    
const res = await fetch(`${process.env.NEXT_PUBLIC_SERVER_URL}/api/admin/allorders/${adminorderid}`,{
method: "PATCH",
headers:{
