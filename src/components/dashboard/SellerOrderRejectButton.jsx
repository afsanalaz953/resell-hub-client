...
const SellerOrderRejectButton = ({rejectedorderid}) => {
     const router = useRouter(); 
    console.log(rejectedorderid)
...
const res = await fetch(`${process.env.NEXT_PUBLIC_SERVER_URL}/api/orders/${rejectedorderid}`,{
method: "DELETE",
headers:{
